...
const createMessageDB = (message, owner, isPrivat, createdAt, time, to) => DBmessage.create({
  message,
  owner,
  isPrivat,
  createdAt,
...
export {
  getMessagesDB, getPrivatMessagesDB, createMessageDB, deleteMessage, updateMessage,
};
